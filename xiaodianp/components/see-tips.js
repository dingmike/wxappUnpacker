...
var d = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
    ...
    function j() {
        ...
        return d = e = b(this, (c = j.__proto__ || Object.getPrototypeOf(j)).call.apply(c, [ this ].concat(h))), 
        e.data = {
            reveal: !1,
            animationData: "",
            title: "see不到啦~",
    ...
    return c(j, h), f(j, [ {
        ...
        value: function() {
            ...
            if (this.$apply(), clearTimeout(this.__timeout), setTimeout(function() {
                ...
                b.scaleY(1).step(), a.animationData = b.export(), a.reveal = !0, a.$apply();
            }, 30), 0 === b.duration) {
        ...
        value: function() {
            ...
            return a.scaleY(0).step(), this.animationData = a.export(), this.$apply(), this.hasPromise ? new Promise(function(a) {
                a();
